      ...
      <article className="min-w-[150px] py-[6px] mt-2 animate-fadeInDelayed">
        <section className="relative inline-block bg-nephritis text-black text-lg font-semibold px-4 py-2 rounded-lg box-content">
          <div className="flex gap-[0.5px]">
            ...
            <Text className="text-lg mr-[0.5px] font-black text-primary_green" size={'mdx'}>
              {' '}
              월 100만원{' '}
            </Text>
          </div>
      ...
      <div className="carousel overflow-hidden mx-auto mt-5 max-md:mt-5 flex justify-center relative w-full max-w-[900px] h-full animate-fadeIn">
        ...
        {slider_content.map((item, index) => {
          ...
          return (
            <section
              key={index}
              className={`carousel-item absolute max-w-[292px] max-md:max-w-full max-md:w-[234px] w-1/2 max-h-[408px] h-full max-md:h-[311px] transition-transform duration-500 ease-in-out ${
                isActive
              ...
              <CardBox
                className="item-content h-full flex justify-center flex-col items-center"
                variant={'secondary'}
                size={'lg'}>
                <div className="top_slider_card_section flex justify-center items-center flex-col">
                  ...
                  <Text size={'md'} className="text-[#4a77ff] leading-[150%] font-black text-center max-md:text-sm">
                    {job}
                  </Text>
                </div>
                <div className="bottom_slider_card_section mt-4 md:mt-9 flex flex-col justify-center items-center gap-1">
                  <article className="w-fit rounded-md py-1 px-3 border-[#c1c5cf] border-2">
                    <Text className="leading-[150%] text-sm md:text-base font-black" variant={'lightest_dark'}>
                      {description}
                    </Text>
                  </article>
                  <article className="w-fit rounded-md py-1 px-3 border-[#c1c5cf] border-2">
        ...
        {/* Navigation Arrows */}
        <span
          className="material-symbols-outlined -left-4 max-lg:left-20 max-md:left-0 max-md:top-[30%] absolute top-[40%] cursor-pointer z-20 text-white"
          style={{ fontSize: '50px' }}
